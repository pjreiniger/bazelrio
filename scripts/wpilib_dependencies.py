...
def _cpp_dependency(maven_dep, artifact_name, fail_on_hash_miss=True):
...
def get_wpilib_dependencies():
    ...
    VERSIONS = ["2021.3.1", "2022.1.1-beta-1", "2022.1.1-beta-2", "2022.1.1", "2022.2.1", "2022.3.1", "2022.4.1", "2022.4.1", "2023.0.0-alpha-1", "2023.0.0-alpha-2"]
    DEP_NAME = "wpilib"
